...
class UM_Instagram_API {
	 ...
	 */
	function connect() {
		if ( ! class_exists( 'um_ext\um_instagram\core\Instagram_Connect' ) )
		require_once um_instagram_path . 'includes/core/class-instagram-connect.php';
	 ...
	 */
	function admin() {
		if ( ! class_exists( 'um_ext\um_instagram\admin\Instagram_Admin' ) )
		require_once um_instagram_path . 'includes/admin/class-instagram-admin.php';
	 ...
	 */
	function frontend() {
		if ( ! class_exists( 'um_ext\um_instagram\core\Instagram_Public' ) )
		require_once um_instagram_path . 'includes/core/class-instagram-public.php';
