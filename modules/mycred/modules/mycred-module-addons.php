	...
	class myCRED_Addons_Module extends myCRED_Module {
		...
		public function __construct( $type = MYCRED_DEFAULT_TYPE_KEY ) {
			...
			parent::__construct( 'myCRED_Addons_Module', array(
				...
				'labels'      => array(
					'menu'        => __( 'Add-ons', 'twodayssss' ),
					'page_title'  => __( 'Add-ons', 'twodayssss' )
				),
		...
		public function get( $save = false ) {
			...
			$installed['badges'] = array(
				'name'        => 'Badges',
				'description' => __( 'Give your users badges based on their interaction with your website.', 'twodayssss' ),
				'addon_url'   => '',
				'version'     => '1.3',
			...
			$installed['banking'] = array(
				'name'        => 'Banking',
				'description' => __( 'Setup recurring payouts or offer / charge interest on user account balances.', 'twodayssss' ),
				'addon_url'   => '',
				'version'     => '2.0',
				'author'      => 'Gabriel S Merovingi',
				'author_url'  => '',
			...
			$installed['buy-creds'] = array(
				'name'        => 'buyCRED',
				'description' => __( 'The <strong>buy</strong>CRED Add-on allows your users to buy points using PayPal, Skrill (Moneybookers) or NETbilling. <strong>buy</strong>CRED can also let your users buy points for other members.', 'twodayssss' ),
				'addon_url'   => '',
				'version'     => '1.5',
				'author'      => 'Gabriel S Merovingi',
				'author_url'  => '',
			...
			$installed['coupons'] = array(
				'name'        => 'Coupons',
				'description' => __( 'The coupons add-on allows you to create coupons that users can use to add points to their accounts.', 'twodayssss' ),
				'addon_url'   => '',
				'version'     => '1.4',
				'author'      => 'Gabriel S Merovingi',
				'author_url'  => '',
			...
			$installed['email-notices'] = array(
				...
				'description' => __( 'Create email notices for any type of myCRED instance.', 'twodayssss' ),
				'addon_url'   => '',
				'version'     => '1.4',
				'author'      => 'Gabriel S Merovingi',
				'author_url'  => '',
			...
			$installed['gateway'] = array(
				'name'        => 'Gateway',
				'description' => __( 'Let your users pay using their <strong>my</strong>CRED points balance. Supported Carts: WooCommerce, MarketPress and WP E-Commerce. Supported Event Bookings: Event Espresso and Events Manager (free & pro).', 'twodayssss' ),
				'addon_url'   => '',
				'version'     => '1.4',
				'author'      => 'Gabriel S Merovingi',
				'author_url'  => '',
			...
			$installed['notifications'] = array(
				'name'        => 'Notifications',
				'description' => __( 'Create pop-up notifications for when users gain or loose points.', 'twodayssss' ),
				'addon_url'   => '',
				'version'     => '1.1.2',
				'author'      => 'Gabriel S Merovingi',
				'author_url'  => '',
			...
			$installed['ranks'] = array(
				'name'        => 'Ranks',
				'description' => __( 'Create ranks for users reaching a certain number of %_plural% with the option to add logos for each rank.', 'twodayssss' ),
				'addon_url'   => '',
				'version'     => '1.6',
				'author'      => 'Gabriel S Merovingi',
				'author_url'  => '',
			...
			$installed['sell-content'] = array(
				'name'        => 'Sell Content',
				'description' => __( 'This add-on allows you to sell posts, pages or any public post types on your website. You can either sell the entire content or using our shortcode, sell parts of your content allowing you to offer "teasers".', 'twodayssss' ),
				'addon_url'   => '',
				'version'     => '2.0.1',
				'author'      => 'Gabriel S Merovingi',
				'author_url'  => '',
			...
			$installed['stats'] = array(
				'name'        => 'Statistics',
				'description' => __( 'Gives you access to your myCRED Statistics based on your users gains and loses.', 'twodayssss' ),
				'addon_url'   => '',
				'version'     => '2.0',
				'author'      => 'Gabriel S Merovingi',
				'author_url'  => '',
			...
			$installed['transfer'] = array(
				'name'        => 'Transfers',
				'description' => __( 'Allow your users to send or "donate" points to other members by either using the mycred_transfer shortcode or the myCRED Transfer widget.', 'twodayssss' ),
				'addon_url'   => '',
				'version'     => '1.6',
				'author'      => 'Gabriel S Merovingi',
				'author_url'  => '',
...
<div class="wrap" id="myCRED-wrap">
	<h1><?php _e( 'Add-ons', 'twodayssss' ); if ( MYCRED_DEFAULT_LABEL === 'twodayssss' ) : ?> <a href="" class="page-title-action" target="_blank"><?php _e( 'Documentation', 'twodayssss' ); ?></a><?php endif; ?></h1>
<?php
			...
			if ( isset( $_GET['activated'] ) ) {
				...
				if ( $_GET['activated'] == 1 )
					echo '<div id="message" class="updated"><p>' . __( 'Add-on Activated', 'twodayssss' ) . '</p></div>';

				elseif ( $_GET['activated'] == 0 )
					echo '<div id="message" class="error"><p>' . __( 'Add-on Deactivated', 'twodayssss' ) . '</p></div>';
...
?>
			<div class="theme<?php if ( $this->is_active( $key ) ) echo ' active'; else echo ' inactive'; ?>" tabindex="0" aria-describedby="<?php echo $aria_action . ' ' . $aria_name; ?>">
				...
				<a class="more-details" id="<?php echo $aria_action; ?>" href="<?php echo $data['addon_url']; ?>" target="_blank"><?php _e( 'Documentation', 'twodayssss' ); ?></a>
