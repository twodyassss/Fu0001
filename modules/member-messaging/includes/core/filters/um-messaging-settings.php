...
function um_messaging_email_notifications( $email_notifications ) {
	$email_notifications['new_message'] = array(
		'key'           => 'new_message',
		'title'         => __( 'New Message Notification','twodayssss' ),
		...
		'description'   => __('Send a notification to user when he receives a new private message','twodayssss'),
		'recipient'   => 'user',
		'default_active' => true
	);
	$email_notifications['new_message_reminder'] = array(
		'key'           => 'new_message_reminder',
		'title'         => __( 'New Message Reminder','twodayssss' ),
		...
		'body'          => 'Hi {recipient},<br /><br />' .
			...
			'{message_history}<br /><br />' .
			'This is an automated notification from {site_name}. You do not need to reply.',
		'description'   => __('Send a notification to user when he has unread private message','twodayssss'),
		'recipient'   => 'user',
	...
	***/
	...
	function um_messaging_add_notification_type( $array ) {
		...
		$array['new_pm'] = array(
			'title' => __('User get a new private message','twodayssss'),
			'template' => '<strong>{member}</strong> has just sent you a private message.',
			'account_desc' => __('When someone sends a private message to me','twodayssss'),
		);
