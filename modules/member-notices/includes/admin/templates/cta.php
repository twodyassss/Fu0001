	...
	<?php UM()->admin_forms( array(
		...
		'fields' => array(
			array(
				'id'		    => '_um_cta',
				'type'		    => 'checkbox',
				'label'		    => __( 'Enable Call to Action button', 'twodayssss' ),
				'value'		    => UM()->query()->get_meta_value( '_um_cta', null, 0 ),
			),
			array(
				'id'		    => '_um_cta_text',
				'type'		    => 'text',
				'label'		    => __( 'Button Text', 'twodayssss' ),
			...
			array(
				'id'		    => '_um_cta_url',
				'type'		    => 'text',
				'label'		    => __( 'Button URL', 'twodayssss' ),
			...
			array(
				'id'		    => '_um_cta_bg',
				'type'		    => 'color',
				'label'		    => __( 'Button Background Color', 'twodayssss' ),
			...
			array(
				'id'		    => '_um_cta_clr',
				'type'		    => 'color',
				'label'		    => __( 'Button Text Color', 'twodayssss' ),
