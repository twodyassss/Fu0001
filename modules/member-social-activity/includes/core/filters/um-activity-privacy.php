...
function um_activity_account_privacy_fields_add( $fields ) {
	$array = array(
		0 => __( 'Public', 'twodayssss' ),
		1 => __( 'Members', 'twodayssss' ),
		2 => __( 'Only me', 'twodayssss' ),
	);

	$wall_privacy = apply_filters( 'um_activity_wall_privacy_dropdown_values', $array );

	$fields['wall_privacy'] = array(
		'title'         => __( 'Who can see your activity wall?', 'twodayssss' ),
		'metakey'       => 'wall_privacy',
		'type'          => 'select',
		'label'         => __( 'Who can see your activity wall?', 'twodayssss' ),
		'required'      => 0,
		'public'        => 1,
		'editable'      => 1,
		'default'       => 0,
