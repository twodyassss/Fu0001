...
class UM_Online {
	...
	function common() {
		if ( empty( UM()->classes['um_online_common'] ) ) {
			require_once um_online_path . 'includes/core/class-online-common.php';
	 ...
	 */
	function shortcode() {
		require_once um_online_path . 'includes/core/class-online-shortcode.php';
	...
	function member_directory() {
		require_once um_online_path . 'includes/core/class-online-member-directory.php';
