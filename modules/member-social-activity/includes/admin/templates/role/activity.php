	...
	UM()->admin_forms( array(
		...
		'fields'    => array(
			array(
				...
				'type'  => 'checkbox',
				'label' => __( 'Turn off social wall for this user?', 'twodayssss' ),
				'value' => ! empty( $role['_um_activity_wall_off'] ) ? $role['_um_activity_wall_off'] : 0,
			),
			array(
				'id'            => '_um_activity_posts_off',
				'type'          => 'checkbox',
				'label'         => __( 'Do not allow this role to write posts?', 'twodayssss' ),
			...
			array(
				...
				'type'          => 'checkbox',
				'label'         => __( 'Turn off uploading photos?', 'twodayssss' ),
			...
			array(
				...
				'type'          => 'checkbox',
				'label'         => __( 'Do not allow this role to write comments?','twodayssss'),
