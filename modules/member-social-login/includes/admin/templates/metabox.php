...
<div class="norm">
	...
	<?php } else { ?>
		...
		<div style="height:200px;width:100%;margin:auto;background:#f9f9f9;text-align:center;display:table;">
			<div style="display:table-cell;vertical-align:middle;font-size:20px;color:#ccc;text-align:center;"><?php _e('Not enough data to show visual stats','twodayssss'); ?></div>
		</div>
