...
class UM_Followers_API {
	 ...
	 */
	function api() {
		require_once um_followers_path . 'includes/core/class-followers-main-api.php';
	 ...
	 */
	function enqueue() {
		require_once um_followers_path . 'includes/core/class-followers-enqueue.php';
	 ...
	 */
	function shortcode() {
		require_once um_followers_path . 'includes/core/class-followers-shortcode.php';
