...
class UM_Groups_Own_Group extends WP_Widget {
	...
	function __construct() {
		...
		__('Ultimate Member - Groups: Show latest groups', 'twodayssss'), 

		// Widget description
		array( 'description' => __( 'Shows latest groups in a widget.', 'twodayssss' ), ) 
		);
	...
	public function form( $instance ) {
		if ( isset( $instance[ 'title' ] ) ) {
			...
			$title = __( 'Latest Groups', 'twodayssss' );
		}
