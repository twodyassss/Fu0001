...
<h1><?php printf( __( 'Welcome to %s %s', 'twodayssss' ), $name, myCRED_VERSION ); ?></h1>
<div class="about-text"><?php printf( 'An adaptive points management system for WordPress powered websites.', $name ); ?></div>
<p><?php printf( __( 'Thank you for using %s. If you have a moment, please leave a %s.', 'twodayssss' ), $name, sprintf( '<a href="https://wordpress.org/support/plugin/mycred/reviews/?rate=5#new-post" target="_blank">%s</a>', __( 'review', 'twodayssss' ) ) ); ?></p>
...
<h2 class="nav-tab-wrapper wp-clearfix">
	...
	<a class="nav-tab" href="" target="_blank">Documentation</a>
	<a class="nav-tab" href="" target="_blank">Store</a>
</h2>
<?php
