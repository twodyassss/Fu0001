...
function um_mycred_add_field( $fields ) {
	...
	$fields['mycred_default'] = array(
		'title' => __('myCRED Balance','twodayssss'),
		'metakey' => 'mycred_default',
		'type' => 'text',
		'label' => __('myCRED Balance','twodayssss'),
		'required' => 0,
		'public' => 1,
		'editable' => 0,
	...
	$fields['mycred_progress'] = array(
		'title' => __('myCRED Progress','twodayssss'),
		'metakey' => 'mycred_progress',
		'type' => 'text',
		'label' => __('myCRED Progress','twodayssss'),
		'required' => 0,
		'public' => 1,
		'editable' => 0,
		'edit_forbidden' => 1,
	...
	$fields['mycred_badges'] = array(
		'title' => __('myCRED Badges','twodayssss'),
		'metakey' => 'mycred_badges',
		'type' => 'text',
		'label' => __('myCRED Badges','twodayssss'),
		'required' => 0,
		'public' => 1,
		'editable' => 0,
		'edit_forbidden' => 1,
	...
	$fields['mycred_rank'] = array(
		'title' => __('myCRED Rank','twodayssss'),
		'metakey' => 'mycred_rank',
		'type' => 'select',
		'label' => __('myCRED Rank','twodayssss'),
		'required' => 0,
		'public' => 1,
		'editable' => 0,
		'edit_forbidden' => 1,
...
function um_mycred_members_directory_sort_dropdown_options( $options ) {
	$options['most_mycred_points'] = __( 'Most Points', 'twodayssss' );
	$options['least_mycred_points'] = __( 'Least Points', 'twodayssss' );
