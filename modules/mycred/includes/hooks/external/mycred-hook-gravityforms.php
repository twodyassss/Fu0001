...
function mycred_register_gravity_forms_hook( $installed ) {
	...
	$installed['gravityform'] = array(
		'title'         => __( 'Gravityform Submissions', 'twodayssss' ),
		'description'   => __( 'Awards %_plural% for successful form submissions.', 'twodayssss' ),
		'documentation' => '',
...
<div class="hook-instance">
	<h3><?php printf( __( 'Form: %s', 'twodayssss' ), $form->title ); ?></h3>
	<div class="row">
		...
		<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
			<div class="form-group">
				<label for="<?php echo $this->field_id( array( $form->id, 'limit' ) ); ?>"><?php _e( 'Limit', 'twodayssss' ); ?></label>
		...
		<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
			<div class="form-group">
				<label for="<?php echo $this->field_id( array( $form->id, 'log' ) ); ?>"><?php _e( 'Log template', 'twodayssss' ); ?></label>
				<input type="text" name="<?php echo $this->field_name( array( $form->id, 'log' ) ); ?>" id="<?php echo $this->field_id( array( $form->id, 'log' ) ); ?>" placeholder="<?php _e( 'required', 'twodayssss' ); ?>" value="<?php echo esc_attr( $prefs[ $form->id ]['log'] ); ?>" class="form-control" />
