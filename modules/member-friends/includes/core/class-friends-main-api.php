...
class Friends_Main_API {
	...
	function friend_button( $user_id1, $user_id2, $twobtn = false ) {
		...
		if ( ! is_user_logged_in() ) {
			...
			$res = '<a href="' . $redirect . '" class="um-login-to-friend-btn um-button um-alt">'. __( 'Add Friend', 'twodayssss' ). '</a>';
			return $res;
		}
				...
				if ( $pending == $user_id2 ) { // User should respond
					...
					if ( $twobtn == false ) {
						...
						$res = '<div class="um-friend-respond-zone">
							<a href="#" class="um-friend-respond-btn um-button um-alt" data-user_id1="'.$user_id1.'" data-user_id2="'.$user_id2.'">'. __('Respond to Friend Request','twodayssss'). '</a>';

						$items = array(
							'confirm' 	=> '<a href="#" class="um-friend-accept-btn" data-user_id1="'.$user_id1.'" data-user_id2="'.$user_id2.'">'. __('Confirm','twodayssss'). '</a>',
							'delete' 	=> '<a href="#" class="um-friend-reject-btn" data-user_id1="'.$user_id1.'" data-user_id2="'.$user_id2.'">'. __('Delete Request','twodayssss'). '</a>',
							'cancel' 	=> '<a href="#" class="um-dropdown-hide">'.__('Cancel','twodayssss').'</a>',
						);
						...
						$res = '<a href="#" class="um-friend-accept-btn um-button" data-user_id1="'.$user_id1.'" data-user_id2="'.$user_id2.'">'. __('Confirm','twodayssss'). '</a>';
						$res .= '&nbsp;&nbsp;<a href="#" class="um-friend-reject-btn um-button um-alt" data-user_id1="'.$user_id1.'" data-user_id2="'.$user_id2.'">'. __('Delete Request','twodayssss'). '</a>';
					}

				} else {
					$res = '<a href="#" class="um-friend-pending-btn um-button um-alt" data-cancel-friend-request="' . __('Cancel Friend Request','twodayssss') . '" data-pending-friend-request="' . __('Friend Request Sent','twodayssss') . '" data-user_id1="'.$user_id1.'" data-user_id2="'.$user_id2.'">'. __('Friend Request Sent','twodayssss'). '</a>';
				}

			} else {
				$res = '<a href="#" class="um-friend-btn um-button um-alt" data-user_id1="'.$user_id1.'" data-user_id2="'.$user_id2.'">'. __('Add Friend','twodayssss'). '</a>';
			}
		} else {
			$res = '<a href="#" class="um-unfriend-btn um-button um-alt" data-user_id1="'.$user_id1.'" data-user_id2="'.$user_id2.'" data-friends="'.__('Friends','twodayssss').'"  data-unfriend="'.__('Unfriend','twodayssss').'">'. __('Friends','twodayssss'). '</a>';
		}
