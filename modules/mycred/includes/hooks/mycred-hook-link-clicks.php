...
if ( ! class_exists( 'myCRED_Hook_Click_Links' ) ) :
	class myCRED_Hook_Click_Links extends myCRED_Hook {
		...
		public function custom_limit() {
			...
			return array(
				'none' => __( 'No limit', 'twodayssss' ),
				'url'  => __( 'Once for each unique URL', 'twodayssss' ),
				'id'   => __( 'Once for each unique link id', 'twodayssss' )
			);
...
<div class="hook-instance">
	...
	<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
			<div class="form-group">
				<label for=""><?php _e( 'Limits', 'twodayssss' ); ?></label>
<?php 
...
?>
		...
		<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
			<div class="form-group">
				...
				<p class="form-control-static"><a href="" target="_blank">[mycred_link]</a></p>
			</div>
		</div>
	</div>
</div>
