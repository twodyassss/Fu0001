...
class UM_Private_Content_API {
	...
	***/
     ...
     */
    function shortcode() {
		require_once um_private_content_path . 'includes/core/class-private-content-shortcode.php';
     ...
     */
    function admin() {
		require_once um_private_content_path . 'includes/core/class-private-content-admin.php';
    ...
    function admin_upgrade() {
		require_once um_private_content_path . 'includes/admin/core/class-admin-upgrade.php';
