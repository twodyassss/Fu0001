...
class User_Tags_Taxonomies {
	...
	function setup_taxonomy() {
		...
		$labels = array(
			'name'                       => __( 'User Tags', 'twodayssss' ),
			'singular_name'              => __( 'User Tag', 'twodayssss' ),
			'search_items'               => __( 'Search User Tags','twodayssss' ),
			'popular_items'              => __( 'Popular User Tags','twodayssss' ),
			'all_items'                  => __( 'All User Tags','twodayssss' ),
			'parent_item'                => null,
			'parent_item_colon'          => null,
			'edit_item'                  => __( 'Edit User Tag','twodayssss' ),
			'update_item'                => __( 'Update User Tag','twodayssss' ),
			'add_new_item'               => __( 'Add New User Tag','twodayssss' ),
			'new_item_name'              => __( 'New User Tag Name','twodayssss' ),
			'separate_items_with_commas' => __( 'Separate user tags with commas','twodayssss' ),
			'add_or_remove_items'        => __( 'Add or remove user tags','twodayssss' ),
			'choose_from_most_used'      => __( 'Choose from the most used user tags','twodayssss' ),
			'not_found'                  => __( 'No user tags found.','twodayssss' ),
			'menu_name'                  => __( 'User Tags','twodayssss' ),
		);
