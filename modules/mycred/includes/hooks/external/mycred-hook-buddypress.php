...
function mycred_register_buddypress_hook( $installed ) {
	...
	if ( bp_is_active( 'xprofile' ) ) {
		$installed['hook_bp_profile'] = array(
			'title'         => __( 'BuddyPress: Members', 'twodayssss' ),
			'description'   => __( 'Awards %_plural% for profile related actions.', 'twodayssss' ),
			'documentation' => '',
	...
	if ( bp_is_active( 'groups' ) ) {
		$installed['hook_bp_groups'] = array(
			'title'         => __( 'BuddyPress: Groups', 'twodayssss' ),
			'description'   => __( 'Awards %_plural% for group related actions. Use minus to deduct %_plural% or zero to disable a specific hook.', 'twodayssss' ),
			'documentation' => '',
