...
class UM_User_Tags_API {
	 ...
	 */
	function shortcode() {
		require_once um_user_tags_path . 'includes/core/class-user-tags-shortcode.php';
	 ...
	 */
	function enqueue() {
		require_once um_user_tags_path . 'includes/core/class-user-tags-enqueue.php';
	 ...
	 */
	function admin() {
		require_once um_user_tags_path . 'includes/core/class-user-tags-admin.php';
	...
	function admin_upgrade() {
		require_once um_user_tags_path . 'includes/admin/core/class-admin-upgrade.php';
	 ...
	 */
	function taxonomies() {
		require_once um_user_tags_path . 'includes/core/class-user-tags-taxonomies.php';
	...
	function get_tags( $user_id, $metakey ) {
		...
		if ( is_array( $tags ) ) {
			foreach ( $tags as $tag ) {
				...
				if ( $term ) {
					...
					$tagname = sprintf( __( '%s', 'twodayssss' ), $term->name );
		...
		if ( $remaining > 0 ) {
			$value .= '<span class="um-user-tag um-user-tag-more"><a href="javascript:void(0);">' . sprintf(__('%s more', 'twodayssss'), $remaining) . '</a></span>';
		}
