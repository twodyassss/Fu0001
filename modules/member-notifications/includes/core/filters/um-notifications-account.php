...
if ( ! defined( 'ABSPATH' ) ) exit;
	...
	***/
	...
	function um_notification_account_tab( $tabs ) {
		...
		$tabs[445]['webnotifications']['title'] = __('Web notifications','twodayssss');
		$tabs[445]['webnotifications']['submit_title'] = __('Update Settings','twodayssss');
	...
	***/
	...
	function um_account_content_hook_webnotifications( $output ) {
		...
		<div class="um-field" data-key="">
			<div class="um-field-label"><strong><?php _e( 'Receiving Notifications', 'twodayssss' ); ?></strong></div>
