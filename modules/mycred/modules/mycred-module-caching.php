...
?>
<h4><span class="dashicons dashicons-admin-tools static"></span><?php _e( 'Optimization', 'twodayssss' ); ?></h4>
	...
	<div class="row">
		<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
			<div class="form-group">
				<label><?php _e( 'History', 'twodayssss' ); ?></label>
				<div class="radio">
					<label for="<?php echo $this->field_id( 'caching-off' ); ?>"><input type="radio" name="<?php echo $this->field_name( array( 'caching', 'history' ) ); ?>" id="<?php echo $this->field_id( 'caching-off' ); ?>"<?php checked( $this->caching['history'], 'off' ); ?> value="off" /> <?php _e( 'No caching', 'twodayssss' ); ?></label>
				</div>
				<div class="radio">
					<label for="<?php echo $this->field_id( 'caching-event' ); ?>"><input type="radio" name="<?php echo $this->field_name( array( 'caching', 'history' ) ); ?>" id="<?php echo $this->field_id( 'caching-event' ); ?>"<?php checked( $this->caching['history'], 'event' ); ?> value="event" /> <?php _e( 'Clear cache each time a users balance changes', 'twodayssss' ); ?></label>
				</div>
				<div class="radio">
					<label for="<?php echo $this->field_id( 'caching-day' ); ?>"><input type="radio" name="<?php echo $this->field_name( array( 'caching', 'history' ) ); ?>" id="<?php echo $this->field_id( 'caching-day' ); ?>"<?php checked( $this->caching['history'], 'day' ); ?> value="day" /> <?php _e( 'Clear cache once a day', 'twodayssss' ); ?></label>
				</div>
				<div class="radio">
					<label for="<?php echo $this->field_id( 'caching-manual' ); ?>"><input type="radio" name="<?php echo $this->field_name( array( 'caching', 'history' ) ); ?>" id="<?php echo $this->field_id( 'caching-manual' ); ?>"<?php checked( $this->caching['history'], 'manual' ); ?> value="manual" /> <?php _e( 'Clear cache manually', 'twodayssss' ); ?></label>
				</div>
				<hr />
				<button type="button" data-cache="history" data-type="<?php echo esc_attr( $this->mycred_type ); ?>" class="button clear-type-cache-button"<?php if ( $this->caching['history'] == 'off' ) echo ' disabled="disabled"'; ?> id=""><?php _e( 'Clear Cache Now', 'twodayssss' ); ?></button>
			</div>
		</div>
		<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
			<div class="form-group">
				<label><?php _e( 'Leaderboards', 'twodayssss' ); ?></label>
				<div class="radio">
					<label for="<?php echo $this->field_id( 'leaderboard-caching-off' ); ?>"><input type="radio" name="<?php echo $this->field_name( array( 'caching', 'leaderboards' ) ); ?>" id="<?php echo $this->field_id( 'leaderboard-caching-off' ); ?>"<?php checked( $this->caching['leaderboards'], 'off' ); ?> value="off" /> <?php _e( 'No caching', 'twodayssss' ); ?></label>
				</div>
				<div class="radio">
					<label for="<?php echo $this->field_id( 'leaderboard-caching-event' ); ?>"><input type="radio" name="<?php echo $this->field_name( array( 'caching', 'leaderboards' ) ); ?>" id="<?php echo $this->field_id( 'leaderboard-caching-event' ); ?>"<?php checked( $this->caching['leaderboards'], 'event' ); ?> value="event" /> <?php _e( 'Clear cache each time a users balance changes', 'twodayssss' ); ?></label>
				</div>
				<div class="radio">
					<label for="<?php echo $this->field_id( 'leaderboard-caching-day' ); ?>"><input type="radio" name="<?php echo $this->field_name( array( 'caching', 'leaderboards' ) ); ?>" id="<?php echo $this->field_id( 'leaderboard-caching-day' ); ?>"<?php checked( $this->caching['leaderboards'], 'day' ); ?> value="day" /> <?php _e( 'Clear cache once a day', 'twodayssss' ); ?></label>
				</div>
				<div class="radio">
					<label for="<?php echo $this->field_id( 'leaderboard-caching-manual' ); ?>"><input type="radio" name="<?php echo $this->field_name( array( 'caching', 'leaderboards' ) ); ?>" id="<?php echo $this->field_id( 'leaderboard-caching-manual' ); ?>"<?php checked( $this->caching['leaderboards'], 'manual' ); ?> value="manual" /> <?php _e( 'Clear cache manually', 'twodayssss' ); ?></label>
				</div>
				<hr />
				<button type="button" data-cache="leaderboards" data-type="<?php echo esc_attr( $this->mycred_type ); ?>" class="button clear-type-cache-button"<?php if ( $this->caching['leaderboards'] == 'off' ) echo ' disabled="disabled"'; ?> id=""><?php _e( 'Clear Cache Now', 'twodayssss' ); ?></button>
			</div>
		</div>
		<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
			<div class="form-group">
				<label for="<?php echo $this->field_id( 'auto-delete' ); ?>"><?php _e( 'Auto Delete Log Entries', 'twodayssss' ); ?></label>
				<?php if ( ! MYCRED_ENABLE_LOGGING ) : ?>
				<p><span class="description"><?php _e( 'Log disabled', 'twodayssss' ); ?></span></p>
				<?php else : ?>
				...
				<p><span class="description"><?php printf( _x( "Option to automatically delete log entries after certain number of days. Please read the %s before using this feature as it's use has consequences! Use zero to disable.", 'documentation', 'twodayssss' ), sprintf( '<a href="" target="_blank">%s</a>', __( 'documentation', 'twodayssss' ) ) ); ?></span></p>
				<?php endif; ?>
			</div>
		</div>
	</div>
