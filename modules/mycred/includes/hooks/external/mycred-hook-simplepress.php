...
function mycred_register_simplepress_hook( $installed ) {
	...
	$installed['hook_simplepress'] = array(
		'title'         => 'Simple:Press',
		'description'   => __( 'Awards %_plural% for Simple:Press actions.', 'twodayssss' ),
		'documentation' => '',
...
<div class="hook-instance">
	<h3><?php _e( 'New Topic Post', 'twodayssss' ); ?></h3>
	<div class="row">
		<div class="col-lg-2 col-md-6 col-sm-12 col-xs-12">
			<div class="form-group">
...
<div class="hook-instance">
	<h3><?php _e( 'Deleted Topic Post', 'twodayssss' ); ?></h3>
	<div class="row">
		<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
			<div class="form-group">
		...
		<div class="col-lg-8 col-md-6 col-sm-12 col-xs-12">
			<div class="form-group">
				<label for="<?php echo $this->field_id( array( 'delete_post', 'log' ) ); ?>"><?php _e( 'Log template', 'twodayssss' ); ?></label>
				<input type="text" name="<?php echo $this->field_name( array( 'delete_post', 'log' ) ); ?>" id="<?php echo $this->field_id( array( 'delete_post', 'log' ) ); ?>" placeholder="<?php _e( 'required', 'twodayssss' ); ?>" value="<?php echo esc_attr( $prefs['delete_post']['log'] ); ?>" class="form-control" />
				<span class="description"><?php echo $this->available_template_tags( array( 'general' ) ); ?></span>
			</div>
		</div>
	</div>
