...
class UM_Reviews_API {
     ...
     */
    function api() {
		if ( ! class_exists( 'um_ext\um_reviews\core\Reviews_Main_API' ) )
		require_once um_reviews_path . 'includes/core/class-reviews-main-api.php';
     ...
     */
    function admin() {
		if ( ! class_exists( 'um_ext\um_reviews\core\Reviews_Admin' ) )
		require_once um_reviews_path . 'includes/core/class-reviews-admin.php';
     ...
     */
    function enqueue() {
		if ( ! class_exists( 'um_ext\um_reviews\core\Reviews_Enqueue' ) )
		require_once um_reviews_path . 'includes/core/class-reviews-enqueue.php';
	 ...
	 */
	function shortcode() {
		if ( ! class_exists( 'um_ext\um_reviews\core\Reviews_Shortcode' ) )
		require_once um_reviews_path . 'includes/core/class-reviews-shortcode.php';
	...
	function admin_upgrade() {
		...
		require_once um_reviews_path . 'includes/admin/core/class-admin-upgrade.php';
