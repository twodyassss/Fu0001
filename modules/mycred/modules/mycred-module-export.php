...
if ( ! class_exists( 'myCRED_Export_Module' ) ) :
	class myCRED_Export_Module extends myCRED_Module {
		...
		public function add_export_trigger_to_title( $title, $log_module ) {
			...
			$title .= ' <a href="javascript:void(0)" class="toggle-exporter add-new-h2" data-toggle="export-log-history">' . __( 'Export', 'twodayssss' ) . '</a>';
...
<div style="display:none;" class="clear" id="export-log-history">
	<strong><?php _e( 'Export', 'twodayssss' ); ?>:</strong>
	<div>
<?php
...
<?php
		...
		public function after_general_settings( $mycred = NULL ) {
			...
			$enabled_disabled = array(
				0 => __( 'Disabled', 'twodayssss' ),
				1 => __( 'Enabled', 'twodayssss' )
			);

			$export_formats         = mycred_get_export_formats();
			$export_formats['both'] = __( 'Make both format options available.', 'twodayssss' );
?>
<h4><span class="dashicons dashicons-admin-plugins static"></span><?php _e( 'Exports', 'twodayssss' ); ?></h4>
<div class="body" style="display: none;">

	<div class="row">
		<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
			<div class="form-group">
				<label class="mycred-export-prefs-front-end"><?php _e( 'Front End Exports', 'twodayssss' ); ?></label>
...
?>
		...
		<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
			<div class="form-group">
				<label for="mycred-export-prefs-front-end-format"><?php _e( 'Export Format', 'twodayssss' ); ?></label>
...
?>
		...
		<div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
			<div class="form-group">
				<label for="mycred-export-prefs-front-end-name"><?php _e( 'File Name', 'twodayssss' ); ?></label>
				...
				<p><span class="description"><?php echo '<code>%point_type%</code> = ' . __( 'Point Type', 'twodayssss' ) . ', <code>%username%</code> = ' . __( 'Username', 'twodayssss' ); ?></span></p>
			</div>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<p><span class="description"><?php echo str_replace( 'mycred_history', '<a href="" target="_blank">mycred_history</a>', __( 'If enabled, users will only be able to export their own log entries! Export tools becomes available wherever you are using the mycred_history shortcode or in the users profile.', 'twodayssss' ) ); ?></span></p>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
			<div class="form-group">
				<label class="mycred-export-prefs-admin-end"><?php _e( 'Back End Exports', 'twodayssss' ); ?></label>
...
?>
		...
		<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
			<div class="form-group">
				<label for="mycred-export-prefs-admin-end-format"><?php _e( 'Export Format', 'twodayssss' ); ?></label>
...
?>
		...
		<div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
			<div class="form-group">
				<label for="mycred-export-prefs-admin-end-name"><?php _e( 'File Name', 'twodayssss' ); ?></label>
	...
	<div class="row">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<p><span class="description"><?php _e( 'Raw format should be used when you intend to use the export tool to backup or import entries in another installation. Formatted exports reflect what users see in their history archive.', 'twodayssss' ); ?></span></p>
		</div>
	</div>
