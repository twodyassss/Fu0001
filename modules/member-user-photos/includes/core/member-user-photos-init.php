...
class UM_Photos_API {
	...
	function admin() {
		...
		require_once um_user_photos_path . 'includes/admin/class-admin.php';
	 ...
	 */
	function shortcodes() {
		if ( ! class_exists( 'um_ext\um_user_photos\core\User_Photos_Shortcodes' ) )
		require_once um_user_photos_path . 'includes/core/class-user-photos-shortcodes.php';
	 ...
	 */
	function common() {
		if ( ! class_exists( 'um_ext\um_user_photos\core\User_Photos_Common' ) )
		require_once um_user_photos_path . 'includes/core/class-user-photos-common.php';
	...
	function activity() {
		...
		if ( ! class_exists( 'um_ext\um_user_photos\core\User_Photos_Activity' ) )
		require_once um_user_photos_path . 'includes/core/class-user-photos-activity.php';
	 ...
	 */
	function profile() {
		if ( ! class_exists( 'um_ext\um_user_photos\core\User_Photos_Profile' ) )
		require_once um_user_photos_path . 'includes/core/class-user-photos-profile.php';
	 ...
	 */
	function account() {
		if ( ! class_exists( 'um_ext\um_user_photos\core\User_Photos_Account' ) )
		require_once um_user_photos_path . 'includes/core/class-user-photos-account.php';
	 ...
	 */
	function ajax() {
		if ( ! class_exists( 'um_ext\um_user_photos\core\User_Photos_Ajax' ) )
		require_once um_user_photos_path . 'includes/core/class-user-photos-ajax.php';
