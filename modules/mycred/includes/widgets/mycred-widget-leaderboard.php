...
<p class="myCRED-widget-field">
    <label for="<?php echo esc_attr( $this->get_field_id( 'total' ) ); ?>"><?php _e( 'Total', 'twodayssss' ); ?>:</label>
    ...
    <small><?php _e( 'When showing a leaderboard based on balances, you can select to use users total balance (1) instead of their current balance (0).', 'twodayssss' ); ?> </small>
</p>
 
<p class="myCRED-widget-field">
    <label for="<?php echo esc_attr( $this->get_field_id( 'wrap' ) ); ?>"><?php _e( 'Wrap', 'twodayssss' ); ?>:</label>
    ...
    <small><?php _e( 'The wrapping element to use for the list. By default the leaderboard renders an organized list (ol) and each item uses a list element (li).', 'twodayssss' ); ?> </small>
</p>
 
<p class="myCRED-widget-field">
    <label for="<?php echo esc_attr( $this->get_field_id( 'nothing' ) ); ?>"><?php _e( 'Nothing', 'twodayssss' ); ?>:</label>
    ...
    <small><?php _e( 'The message to show users when the leaderboard is empty.', 'twodayssss' ); ?></small>
</p>
 
<p class="myCRED-widget-field">
    <label for="<?php echo esc_attr( $this->get_field_id( 'exclude_zero' ) ); ?>"><?php _e( 'Exclude Zero', 'twodayssss' ); ?>:</label>
    ...
    <small><?php _e( 'Option to filter out users with zero balances / results. Use 1 to enable and 0 to disable.', 'twodayssss' ); ?> </small>
</p>
...
<p class="myCRED-widget-field">
    <label for="<?php echo esc_attr( $this->get_field_id( 'row_layout' ) ); ?>"><?php _e( 'Row layout', 'twodayssss' ); ?>:</label>
