...
class UM_Social_Login_API {
	...
	function init_networks() {
		$this->networks['facebook'] = array(
			...
			'button'    => __( 'Connect with Facebook', 'twodayssss' ),
			'color'     => '#fff',
			'bg'        => '#4267B2',
			'bg_hover'  => '#365899',
	 ...
	 */
	function admin() {
		if ( ! class_exists( 'um_ext\um_social_login\core\Social_Login_Admin' ) ) 
		require_once um_social_login_path . 'includes/core/class-social-login-admin.php';
	 ...
	 */
	function enqueue() {
		if ( ! class_exists( 'um_ext\um_social_login\core\Social_Login_Enqueue' ) ) 
		require_once um_social_login_path . 'includes/core/class-social-login-enqueue.php';
	 ...
	 */
	function shortcode() {
		if ( ! class_exists( 'um_ext\um_social_login\core\Social_Login_Shortcode' ) ) 
		require_once um_social_login_path . 'includes/core/class-social-login-shortcode.php';
	 ...
	 */
	function ajax() {
		if ( ! class_exists( 'um_ext\um_social_login\core\Social_Login_Ajax' ) ) 
		require_once um_social_login_path . 'includes/core/class-social-login-ajax.php';
	...
	function disconnect() {
		...
		if ( get_current_user_id() != $_REQUEST['uid'] ) {
			wp_die( __( 'Ehh! hacking?', 'twodayssss' ) );
		}
	...
	function show_submit_button() {
		...
		<div class="um-col-alt">
			...
			<div class="um-center"><input type="submit" value="<?php _e('Complete Registration','twodayssss'); ?>" class="um-button" /></div>
	...
	function error_message_handler( $err, $error_code ) {
		...
		switch ( $error_code ) {
			case 'um_social_user_denied':
				return __( 'We were unable to request application access permissions.', 'twodayssss' );
				break;

			case 'um_social_unauthorized_scope_error':
				return __( 'One of the scopes is not authorized by your developer application.', 'twodayssss' );
				break;
