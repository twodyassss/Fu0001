...
if ( UM()->Reviews_API()->api()->can_review( um_profile_id() ) ) {
	...
	<div class="um-reviews-item">
		...
		<div class="um-reviews-prepost"><i class="um-faicon-pencil"></i> <?php _e('Write a review for this user','twodayssss'); ?></div>
		...
		<div class="um-reviews-post review-form">
			...
			<form class="um-reviews-form" action="" method="post">
				...
				<span class="um-reviews-title"><input type="text" required="required" name="title" placeholder="<?php esc_attr_e('Enter subject...','twodayssss'); ?>" maxlength="60" /></span>

				<span class="um-reviews-meta"><?php printf(__('by <a href="%s">%s</a>, %s','twodayssss'), um_user_profile_url(), um_user('display_name'), current_time( UM()->options()->get( 'review_date_format' ) ) ); ?></span>

				<span class="um-reviews-content"><textarea name="content" required="required" placeholder="<?php esc_attr_e('Enter your review...','twodayssss'); ?>"></textarea></span>
				...
				<span class="um-reviews-send"><input type="submit" value="<?php esc_attr_e('Submit Review','twodayssss'); ?>" class="um-button" /></span>
...
if ( ! is_user_logged_in() ) {
	...
	printf( __('You are not logged in. Please <a href="%s">login</a> to review this user.','twodayssss'), $login_url );
