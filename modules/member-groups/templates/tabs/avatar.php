...
<form action="" method="post"  enctype="multipart/form-data">
	...
	<input type="submit" name="um_groups_upload_avatar" value="<?php esc_attr_e('Upload', 'twodayssss' ) ?>" />

	<?php if( has_post_thumbnail() ) { ?>
		<input type="submit" name="um_groups_delete_avatar" value="<?php esc_attr_e('Delete', 'twodayssss' ) ?>" />
	<?php }
