...
class UM_Messaging_API {
	 ...
	 */
	function api() {
		require_once um_messaging_path . 'includes/core/class-messaging-main-api.php';
	 ...
	 */
	function enqueue() {
		require_once um_messaging_path . 'includes/core/class-messaging-enqueue.php';
	 ...
	 */
	function shortcode() {
		require_once um_messaging_path . 'includes/core/class-messaging-shortcode.php';
	 ...
	 */
	function gdpr() {
		require_once um_messaging_path . 'includes/core/class-messaging-gdpr.php';
	 ...
	 */
	function account() {
		require_once um_messaging_path . 'includes/core/class-messaging-account.php';
	 ...
	 */
	function profile() {
		require_once um_messaging_path . 'includes/core/class-messaging-profile.php';
	...
	function admin_upgrade() {
		require_once um_messaging_path . 'includes/admin/core/class-admin-upgrade.php';
	 ...
	 */
	function admin() {
		require_once um_messaging_path . 'includes/admin/core/class-messaging-admin.php';
