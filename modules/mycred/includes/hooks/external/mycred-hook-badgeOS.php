...
function mycred_register_badgeos_hook( $installed ) {
	...
	$installed['badgeos'] = array(
		'title'         => __( 'BadgeOS', 'twodayssss' ),
		'description'   => __( 'Default settings for each BadgeOS Achievement type. These settings may be overridden for individual achievement type.', 'twodayssss' ),
		'documentation' => '',
	...
	class myCRED_Hook_BadgeOS extends myCRED_Hook {
		...
		public function render_meta_box( $post ) {
			...
			if ( ! isset( $this->prefs[ $post->post_type ] ) ) {
				...
				echo '<p>' . sprintf( __( 'Please setup your <a href="%s">default settings</a> before using this feature.', 'twodayssss' ), admin_url( 'admin.php?page=' . $page ) ) . '</p>';
				return;
...
?>
<p><strong><?php echo $this->core->template_tags_general( __( '%plural% to Award', 'twodayssss' ) ); ?></strong></p>
<p>
	<label class="screen-reader-text" for="mycred-values-<?php echo $this->mycred_type; ?>-creds"><?php echo $this->core->template_tags_general( __( '%plural% to Award', 'twodayssss' ) ); ?></label>
...
<p><strong><?php _e( 'Log Template', 'twodayssss' ); ?></strong></p>
<p>
	<label class="screen-reader-text" for="mycred-values-<?php echo $this->mycred_type; ?>-log"><?php _e( 'Log Template', 'twodayssss' ); ?></label>
...
?>
<p><strong><?php _e( 'Deduction Log Template', 'twodayssss' ); ?></strong></p>
<p>
	<label class="screen-reader-text" for="mycred-values-<?php echo $this->mycred_type; ?>-log"><?php _e( 'Log Template', 'twodayssss' ); ?></label>
...
<div class="hook-instance">
	<h3><?php printf( __( 'Earning: %s', 'twodayssss' ), $post_type_object->labels->singular_name ); ?></h3>
	<div class="row">
		...
		<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
			<div class="form-group">
				<label for="<?php echo $this->field_id( array( $post_type, 'log' ) ); ?>"><?php _e( 'Log Template', 'twodayssss' ); ?></label>
				<input type="text" name="<?php echo $this->field_name( array( $post_type, 'log' ) ); ?>" id="<?php echo $this->field_id( array( $post_type, 'log' ) ); ?>" placeholder="<?php _e( 'required', 'twodayssss' ); ?>" value="<?php echo esc_attr( $prefs[ $post_type ]['log'] ); ?>" class="form-control" />
...
<div class="hook-instance">
	<h3><?php printf( __( 'Revoked: %s', 'twodayssss' ), $post_type_object->labels->singular_name ); ?></h3>
	<div class="row">
		<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
			<div class="form-group">
		...
		<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
			<div class="form-group">
				<label for="<?php echo $this->field_id( array( $post_type, 'deduct_log' ) ); ?>"><?php _e( 'Log Template', 'twodayssss' ); ?></label>
				<input type="text" name="<?php echo $this->field_name( array( $post_type, 'deduct_log' ) ); ?>" id="<?php echo $this->field_id( array( $post_type, 'deduct_log' ) ); ?>" placeholder="<?php _e( 'required', 'twodayssss' ); ?>" value="<?php echo esc_attr( $prefs[ $post_type ]['deduct_log'] ); ?>" class="form-control" />
				<span class="description"><?php echo $this->available_template_tags( array( 'general', 'post' ) ); ?></span>
			</div>
		</div>
	</div>
