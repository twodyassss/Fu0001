...
function um_bbpress_user_topics( $args ) {
	...
	twodays_get_template( 'topics.php', um_bbpress_plugin, $t_args, true );
}
...
function um_bbpress_user_replies( $args ) {
	...
	$t_args = compact( 'args', 'loop' );
	twodays_get_template( 'replies.php', um_bbpress_plugin, $t_args, true );
}
...
function um_bbpress_user_favorites( $args ) {
	...
	twodays_get_template( 'favorites.php', um_bbpress_plugin, $t_args, true );
}
...
function um_bbpress_user_subscriptions( $args ) {
	...
	twodays_get_template( 'subscriptions.php', um_bbpress_plugin, $t_args, true );
}
