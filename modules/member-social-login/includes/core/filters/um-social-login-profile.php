...
function um_social_login_mycred_hooks( $installed, $point_type ) {
	...
	$installed['um-mycred-social-login-connect'] = array(
		'title'        => __( 'Ultimate Member - Connect Social Account', 'twodayssss' ),
		'description'  => __( 'Award points for users connecting Social Network.', 'twodayssss' ),
		'callback'     => array( 'UM_myCRED_Social_Login_Connect' )
	);

	// Disconnect
	$installed['um-mycred-social-login-disconnect'] = array(
		'title'        => __( 'Ultimate Member - Disconnect Social Account', 'twodayssss' ),
		'description'  => __( 'Deduct points for users disconnecting Social Network.', 'twodayssss' ),
...
function um_social_login_mycred_references( $hooks ) {
	...
	$hooks = array_merge( $hooks, array(
		'um-mycred-social-login-connect'    => __( 'Ultimate Member - Social Login Connect', 'twodayssss' ),
	) );
