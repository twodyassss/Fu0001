	...
	function admin_enqueue_scripts( $hook ) {
		...
		if ( 'post-new.php' == $hook || 'post.php' == $hook || 'edit.php' == $hook ) {
			if ( isset( $post->post_type ) && 'um_groups' === $post->post_type ) {
				...
				wp_register_script('um_groups_admin', um_groups_url . 'assets/js/um-groups-admin.js', array( 'jquery', 'wp-util', 'suggest', 'jquery-datatables', 'um_admin_global' ), um_groups_version, true );

				wp_register_style('jquery-datatables', um_groups_url . 'assets/css/jquery.dataTables.css', array(), um_groups_version );
				wp_register_style('um_groups_admin', um_groups_url . 'assets/css/um-groups-admin.css', array( 'jquery-datatables' ), um_groups_version );
	...
	function localize_data( $data ) {
		$data['groups_settings'] = array(
			...
			'labels' => array(
				...
				'confirm_expel'		=> __('Are you sure that you want to expel this member?','twodayssss'),
				'confirm_remove_self' => __('Are you sure that you want to leave this group?','twodayssss'),
				'display'			=> __('Display','twodayssss'),
				'expel'				=> __('Expel','twodayssss'),
				'invite' 			=> __('Invite','twodayssss'),
				'invited' 			=> __('Invited','twodayssss'),
				'length_menu' 		=> __('Display _MENU_ profiles per page','twodayssss'),
				'members'			=> __('members','twodayssss'),
				'no_members_found'	=> __('No members found','twodayssss'),
				'no_members_yet'	=> __('No members yet','twodayssss'),
				'pagination_info'	=> __('Showing _START_ to _END_ of _TOTAL_ members','twodayssss'),
				'pagination_info_empty'		=> __('Showing 0 to 0 of 0 members','twodayssss'),
				'pagination_info_filtered'	=> __('(filtered from _MAX_ total members)','twodayssss'),
				'processing'		=> __('Loading members...','twodayssss'),
				'resend'			=> __('Resend','twodayssss'),
				'reject'			=> __('Reject','twodayssss'),
				'search_name'		=> __('Search name:','twodayssss'),
				'resent_invite'		=> __('Sent','twodayssss'),
				'unblock'			=> __('Unblock','twodayssss'),
				'went_wrong'		=> __('Something went wrong. Please try again','twodayssss'),
			)
		);
