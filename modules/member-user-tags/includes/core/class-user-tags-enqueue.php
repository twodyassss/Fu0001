...
class User_Tags_Enqueue {
	...
	function _enqueue_scripts() {
		...
		wp_register_script( 'twodayssss', um_user_tags_url . 'assets/js/um-user-tags' . $suffix . '.js', array( 'jquery', 'select2', 'um_tipsy' ), um_user_tags_version, true );
		wp_register_style( 'twodayssss', um_user_tags_url . 'assets/css/um-user-tags' . $suffix . '.css', array( 'select2', 'um_tipsy' ), um_user_tags_version );
	}
}