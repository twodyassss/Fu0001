			...
			parent::__construct( 'myCRED_BuddyPress', array(
				...
				'defaults'    => array(
					...
					'history_menu_title' => array(
						'me'      => __( "My History", 'twodayssss' ),
						'others'  => __( "%s's History", 'twodayssss' )
					),
					'history_menu_pos'   => 99,
		...
		public function show_balance_profile() {
			...
			if ( ! empty( $mycred_types ) ) {
				...
				foreach ( $mycred_types as $type => $label ) {
					...
					$output  .= sprintf( '<div class="bp-widget mycred"><h4>%s</h4><table class="profile-fields"><tr class="field_1 field_current_balance_' . $type . '"><td class="label">%s</td><td class="data">%s</td></tr></table></div>', $mycred->plural(), __( 'Current balance', 'twodayssss' ), $mycred->format_creds( $balance ) );
...
?>
<form action="" id="mycred-sort-cred-history-form" method="get"><label><?php _e( 'Show:', 'twodayssss' ); ?></label> <?php mycred_types_select_from_dropdown( 'show-ctype', 'mycred-select-type', $type ); ?> <input type="submit" class="btn btn-large btn-primary button button-large button-primary" value="<?php _e( 'Go', 'twodayssss' ); ?>" /></form>
<?php
...
<?php
		...
		public function after_general_settings( $mycred = NULL ) {
			...
			$balance_locations = array(
				''            => __( 'Do not show', 'twodayssss' ),
				'top'         => __( 'Include in Profile Header', 'twodayssss' ),
				'profile_tab' => __( 'Include under the "Profile" tab', 'twodayssss' ),
				'both'        => __( 'Include under the "Profile" tab and Profile Header', 'twodayssss' )
			);

			$history_locations = array(
				''    => __( 'Do not show', 'twodayssss' ),
				'top' => __( 'Show in Profile', 'twodayssss' )
			);
	...
	<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<div class="form-group">
				<label for="<?php echo $this->field_id( 'balance_location' ); ?>"><?php echo $this->core->template_tags_general( __( '%singular% Balance', 'twodayssss' ) ); ?></label>
...
?>
	...
	<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<div class="form-group">
				<label for="<?php echo $this->field_id( 'history_location' ); ?>"><?php echo $this->core->template_tags_general( __( '%plural% History', 'twodayssss' ) ); ?></label>
...
?>
		...
		<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
			<div class="form-group">
				...
				<p><span class="description"><?php _e( 'Title shown to me', 'twodayssss' ); ?></span></p>
			</div>
		</div>
		<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
			<div class="form-group">
				...
				<p><span class="description"><?php _e( 'Title shown to others. Use %s to show the first name.', 'twodayssss' ); ?></span></p>
			</div>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
			<div class="form-group">
				<label for="<?php echo $this->field_id( 'history_menu_pos' ); ?>"><?php _e( 'Menu Position', 'twodayssss' ); ?></label>
				...
				<p><span class="description"><?php printf( '%s %s', __( 'Current menu positions:', 'twodayssss' ), implode( ', ', $bp_nav_positions ) ); ?></span></p>
			</div>
		</div>
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
			<div class="form-group">
				<label for="<?php echo $this->field_id( 'history_url' ); ?>"><?php _e( 'History URL slug', 'twodayssss' ); ?></label>
				...
				<p><span class="description"><?php _e( 'The history page slug. Must be URL friendly.', 'twodayssss' ); ?></span></p>
			</div>
		</div>
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
			<div class="form-group">
				<label for="<?php echo $this->field_id( 'history_num' ); ?>"><?php _e( 'Number of history entries to show', 'twodayssss' ); ?></label>
