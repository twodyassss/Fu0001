	...
	class myCRED_Hooks_Module extends myCRED_Module {
		...
		public function __construct( $type = MYCRED_DEFAULT_TYPE_KEY ) {
			...
			parent::__construct( 'myCRED_Hooks_Module', array(
				...
				'labels'      => array(
					'menu'        => __( 'Hooks', 'twodayssss' ),
					'page_title'  => __( 'Hooks', 'twodayssss' ),
					'page_header' => __( 'Hooks', 'twodayssss' )
				),
		...
		public function get( $save = false ) {
			...
			$installed['registration'] = array(
				'title'         => __( '%plural% for registrations', 'twodayssss' ),
				'description'   => __( 'Award %_plural% for users joining your website.', 'twodayssss' ),
				'documentation' => '',
			...
			$installed['anniversary'] = array(
				'title'         => __( '%plural% for Anniversary', 'twodayssss' ),
				'description'   => __( 'Award %_plural% for each year a user has been member.', 'twodayssss' ),
				'documentation' => '',
			...
			$installed['site_visit'] = array(
				'title'         => __( '%plural% for daily visits', 'twodayssss' ),
				'description'   => __( 'Award %_plural% for visiting your website on a daily basis.', 'twodayssss' ),
				'documentation' => '',
			...
			$installed['view_contents'] = array(
				'title'         => __( '%plural% for viewing content', 'twodayssss' ),
				'description'   => __( 'Award %_plural% for viewing content.', 'twodayssss' ),
				'documentation' => '',
			...
			$installed['logging_in'] = array(
				'title'         => __( '%plural% for logins', 'twodayssss' ),
				'description'   => __( 'Award %_plural% for logging in.', 'twodayssss' ),
				'documentation' => '',
			...
			$installed['publishing_content'] = array(
				'title'         => __( '%plural% for publishing content', 'twodayssss' ),
				'description'   => __( 'Award %_plural% for publishing content.', 'twodayssss' ),
				'documentation' => '',
			...
			$installed['deleted_content'] = array(
				'title'         => __( '%plural% for trashed content', 'twodayssss' ),
				'description'   => __( 'Award or Deduct %_plural% when content gets trashed.', 'twodayssss' ),
				'documentation' => '',
			...
			$installed['comments'] = array(
				'title'         => ( ! function_exists( 'dsq_is_installed' ) ) ? __( '%plural% for comments', 'twodayssss' ) : __( '%plural% for Disqus comments', 'twodayssss' ),
				'description'   => __( 'Award %_plural% for making comments.', 'twodayssss' ),
				'documentation' => '',
			...
			$installed['link_click'] = array(
				'title'         => __( '%plural% for clicking on links', 'twodayssss' ),
				'description'   => str_replace( '%shortcode%', '<a href="" target="_blank">mycred_link</a>', __( 'Award %_plural% for clicks on links generated by the %shortcode% shortcode.', 'twodayssss' ) ),
				'documentation' => '',
			...
			$installed['video_view'] = array(
				'title'         => __( '%plural% for viewing Videos', 'twodayssss' ),
				'description'   => str_replace( '%shortcode%', '<a href="" target="_blank">mycred_video</a>', __( 'Award %_plural% for watches videos embedded using the %shortcode% shortcode.', 'twodayssss' ) ),
				'documentation' => '',
			...
			$installed['affiliate'] = array(
				'title'         => __( '%plural% for referrals', 'twodayssss' ),
				'description'   => __( 'Award %_plural% for signup or visitor referrals.', 'twodayssss' ),
				'documentation' => '',
...
<div class="wrap">
	<h1><?php _e( 'Hooks', 'twodayssss' ); if ( MYCRED_DEFAULT_LABEL === 'twodayssss' ) : ?> <a href="" class="page-title-action" target="_blank"><?php _e( 'Documentation', 'twodayssss' ); ?></a><?php endif; ?></h1>
							...
							<div class="widget-inside mycred-metabox">
								<form method="post" action="" class="form">
									...
									<div class="widget-control-actions">
										<div class="alignleft">
											<a class="widget-control-remove" href="#remove"><?php _e( 'Delete', 'twodayssss' ); ?></a> | <a class="widget-control-close" href="#close"><?php _e( 'Close', 'twodayssss' ); ?></a><?php if ( MYCRED_DEFAULT_LABEL === 'twodayssss' && array_key_exists( 'documentation', $data ) && ! empty( $data['documentation'] ) ) : ?> | <a class="hook-documentation" href="<?php echo esc_url( $data['documentation'] ); ?>" target="_blank">Hook Documentation</a><?php endif; ?>
										</div>
										<div class="alignright">
											<input type="submit" name="savewidget" id="widget-mycred-hook-<?php echo $key; ?>-__i__-savewidget" class="button button-primary widget-control-save right" value="<?php _e( 'Save', 'twodayssss' ); ?>" />
...
<div class="widgets-chooser">
	...
	<div class="widgets-chooser-actions">
		<button class="button-secondary"><?php _e( 'Cancel', 'twodayssss' ); ?></button>
		<button class="button-primary"><?php _e( 'Add Hook', 'twodayssss' ); ?></button>
	</div>
</div>
	...
	<div class="sidebars-column-0">
		<div class="widgets-holder-wrap">
			<div id="sidebar-active" class="widgets-sortables ui-droppable ui-sortable">
				<div class="sidebar-name">
					<div class="sidebar-name-arrow"><br /></div>
					<h2><?php _e( 'Active Hooks', 'twodayssss' ); ?></h2>
				</div>
				<div class="sidebar-description">
					<p class="description"><?php _e( 'The following hooks are used for all users.', 'twodayssss' ); ?></p>
				</div>
<?php
