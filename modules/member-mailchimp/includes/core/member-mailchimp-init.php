...
class UM_Mailchimp_API {
	 ...
	 */
	function api() {
		if ( ! class_exists( 'um_ext\um_mailchimp\core\Mailchimp_Func' ) )
        require_once um_mailchimp_path . 'includes/core/class-mailchimp-func.php';
	 ...
	 */
	function admin() {
		if ( ! class_exists( 'um_ext\um_mailchimp\core\Mailchimp_Admin' ) )
        require_once um_mailchimp_path . 'includes/core/class-mailchimp-admin.php';
	 ...
	 */
	function ajax() {
		if ( ! class_exists( 'um_ext\um_mailchimp\core\Mailchimp_Ajax' ) )
        require_once um_mailchimp_path . 'includes/core/class-mailchimp-ajax.php';
	 ...
	 */
	function log() {
		if ( ! class_exists( 'um_ext\um_mailchimp\core\Mailchimp_Log' ) )
        require_once um_mailchimp_path . 'includes/core/class-mailchimp-log.php';
	...
	function admin_upgrade() {
        ...
        require_once um_mailchimp_path . 'includes/admin/core/class-admin-upgrade.php';
