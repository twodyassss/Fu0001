...
function um_custom_search_field_filter_rating( $attrs ) {
	$attrs['label'] = __( 'User Rating', 'twodayssss' );
	$attrs['options'] = array(
		5 => __( '5 Stars', 'twodayssss' ),
		4 => __( '4 Stars', 'twodayssss' ),
		3 => __( '3 Stars', 'twodayssss' ),
		2 => __( '2 Stars', 'twodayssss' ),
		1 => __( '1 Star', 'um-reviews '),
		0 => __( 'Any rating', 'twodayssss' )
	);
	$attrs['custom'] = true;
...
function um_admin_custom_search_filter_rating( $fields ) {
	...
	$fields['filter_rating'] = array(
		'title' => __( 'Filter by user rating', 'twodayssss' )
	);
