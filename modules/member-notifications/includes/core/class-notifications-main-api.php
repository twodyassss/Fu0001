...
class Notifications_Main_API {
	...
	***/
	function get_log_types() {
		...
		$array['upgrade_role'] = array(
			'title' => __('Role upgrade','twodayssss'),
			'template' => __('Your membership level has been changed from <strong>{role_pre}</strong> to <strong>{role_post}</strong>','twodayssss'),
			'account_desc' => __('When my membership level is changed','twodayssss'),
		);

		$array['comment_reply'] = array(
			'title' => __('New comment reply','twodayssss'),
			'template' => __('<strong>{member}</strong> has replied to one of your comments.','twodayssss'),
			'account_desc' => __('When a member replies to one of my comments','twodayssss'),
		);

		$array['user_comment'] = array(
			'title' => __('New user comment','twodayssss'),
			'template' => __('<strong>{member}</strong> has commented on your <strong>post</strong>. <span class="b1">"{comment_excerpt}"</span>','twodayssss'),
			'account_desc' => __('When a member comments on my posts','twodayssss'),
		);

		$array['guest_comment'] = array(
			'title' => __('New guest comment','twodayssss'),
			'template' => __('A guest has commented on your <strong>post</strong>. <span class="b1">"{comment_excerpt}"</span>','twodayssss'),
			'account_desc' => __('When a guest comments on my posts','twodayssss'),
		);

		$array['profile_view'] = array(
			'title' => __('User view profile','twodayssss'),
			'template' => __('<strong>{member}</strong> has viewed your profile.','twodayssss'),
			'account_desc' => __('When a member views my profile','twodayssss'),
		);

		$array['profile_view_guest'] = array(
			'title' => __('Guest view profile','twodayssss'),
			'template' => __('A guest has viewed your profile.','twodayssss'),
			'account_desc' => __('When a guest views my profile','twodayssss'),
		);
	...
	***/
	function nice_time( $time ) {
		...
		$time = sprintf(__('%s ago','twodayssss'), $nice_time );
