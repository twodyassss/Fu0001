...
class Reviews_Enqueue {
	...
	function wp_enqueue_scripts() {
		...
		$translation_array = array(
			'add_rating'                => __( 'Please add a rating.', 'twodayssss' ),
			'provide_title'             => __( 'You must provide a title.', 'twodayssss' ),
			'provide_review_content'    => __( 'You must provide review content.', 'twodayssss' ),
			'remove'                    => __( 'Remove', 'twodayssss' ),
			'cancel'                    => __( 'Cancel', 'twodayssss' ),
			'star'                      => __( 'Star', 'twodayssss' ),
		);
