...
class um_profile_completeness extends WP_Widget {
	...
	function __construct() {
		...
		__('Ultimate Member - Complete your Profile', 'twodayssss'), 

		// Widget description
		array( 'description' => __( 'Display the user profile completeness widget.', 'twodayssss' ), ) 
		);
	...
	public function form( $instance ) {
		if ( isset( $instance[ 'title' ] ) ) {
			...
			$title = __( 'Complete your Profile', 'twodayssss' );
		}
...
class um_profile_progress_bar extends WP_Widget {
	...
	function __construct() {
		...
		// Widget name will appear in UI
		__('Ultimate Member - Profile Progress Bar', 'twodayssss'), 

		// Widget description
		array( 'description' => __( 'Display the user profile progress bar.', 'twodayssss' ), ) 
		);
	...
	public function form( $instance ) {
		if ( isset( $instance[ 'title' ] ) ) {
			...
			$title = __( 'Profile Progress', 'twodayssss' );
		}
