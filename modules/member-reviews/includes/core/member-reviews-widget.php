...
class um_reviews_lowest_rated extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct(
			...
			__( 'Ultimate Member - Lowest Rated', 'twodayssss' ),

			// Widget description
			array(
				'description' => __( 'Shows your lowest rated users in a widget', 'twodayssss' ),
			)
		);
	...
	public function form( $instance ) {
		if ( isset( $instance[ 'title' ] ) ) {
			...
			$title = __( 'Lowest Rated Users', 'twodayssss' );
		}
		...
		<p>
			...
			<select name="<?php echo $this->get_field_name( 'roles' ); ?>" id="<?php echo $this->get_field_id( 'roles' ); ?>">
				<option value="all" <?php echo "all" == $roles ? "selected" : ""; ?> ><?php _e('All roles','twodayssss'); ?></option>
...
class um_reviews_most_rated extends WP_Widget {
	...
	function __construct() {
		...
		// Widget name will appear in UI
		__('Ultimate Member - Most Rated', 'twodayssss'), 

		// Widget description
		array( 'description' => __( 'Shows your most rated users in a widget', 'twodayssss' ), ) 
		);
	...
	public function form( $instance ) {
		if ( isset( $instance[ 'title' ] ) ) {
			...
			$title = __( 'Most Rated Users', 'twodayssss' );
		}
...
class um_reviews_top_rated extends WP_Widget {
	...
	function __construct() {
		...
		// Widget name will appear in UI
		__('Ultimate Member - Top Rated', 'twodayssss'), 

		// Widget description
		array( 'description' => __( 'Shows your top rated users in a widget', 'twodayssss' ), ) 
		);
	...
	public function form( $instance ) {
		if ( isset( $instance[ 'title' ] ) ) {
			...
			$title = __( 'Top Rated Users', 'twodayssss' );
		}
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'roles' ); ?>"><?php _e( 'Limit to community role:' ); ?></label> 
			<select name="<?php echo $this->get_field_name( 'roles' ); ?>" id="<?php echo $this->get_field_id( 'roles' ); ?>">
				<option value="all" <?php echo ( $roles && "all" == $roles ) ? "selected" : ""; ?> ><?php _e('All roles','twodayssss'); ?></option>
				<?php foreach( UM()->roles()->get_roles() as $key => $value ) { ?>
