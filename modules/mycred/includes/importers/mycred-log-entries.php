...
if ( ! class_exists( 'myCRED_Importer_Log_Entires' ) ) :
	class myCRED_Importer_Log_Entires extends WP_Importer {
		...
		function import( $file ) {
			...
			if ( $ran ) {
				echo '<div class="updated notice notice-success is-dismissible"><p>' . sprintf( __( 'Import complete - A total of <strong>%d</strong> log entries were successfully imported. <strong>%d</strong> was skipped.', 'twodayssss' ), $this->imported, $this->skipped ) . '</p></div>';
				echo '<p><a href="' . admin_url( 'admin.php?page=' . MYCRED_SLUG ) . '" class="button button-large button-primary">' . __( 'View Log', 'twodayssss' ) . '</a></p>';
			}
		...
		public function header() {
			...
			$label = __( 'Import Log Entries', 'twodayssss' );
