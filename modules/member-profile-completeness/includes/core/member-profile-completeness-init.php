...
class UM_Profile_Completeness_API {
	 ...
	 */
	function enqueue() {
		require_once um_profile_completeness_path . 'includes/core/class-profile-completeness-enqueue.php';
	 ...
	 */
	function shortcode() {
		require_once um_profile_completeness_path . 'includes/core/class-profile-completeness-shortcode.php';
	 ...
	 */
	function admin() {
		require_once um_profile_completeness_path . 'includes/core/class-profile-completeness-admin.php';
	 ...
	 */
	function restrict() {
		require_once um_profile_completeness_path . 'includes/core/class-profile-completeness-restrict.php';
	...
	function get_field_title( $key = '' ) {
		...
		if ( ! empty( $fields[ $key ]['label'] ) ) {
			return sprintf( __( '%s', 'twodayssss' ), $fields[ $key ]['label'] );
		}

		if ( ! empty( $fields[ $key ]['title'] ) ) {
			return sprintf( __( '%s', 'twodayssss' ), $fields[ $key ]['title'] );
		}

		return __( 'Custom Field', 'twodayssss' );
	}
	...
	function ajax_edit_popup() {
		...
		<div class="um-completeness-editwrap" data-key="<?php echo $_POST['key']; ?>">
			...
			<div class="um-completeness-header">
				<?php _e( 'Complete your profile', 'twodayssss' ); ?>
			</div>

			<div class="um-completeness-complete">
				<?php printf( __( 'Your profile is %s complete', 'twodayssss' ), '<span style="color:#3ba1da"><strong><span class="um-completeness-jx">' . $result['progress'] . '</span>%</strong></span>' ); ?>
			</div>
			...
			<div class="um-completeness-save">
				<a href="#" class="save"><?php _e( 'Save', 'twodayssss' ); ?></a>
				<a href="#" class="skip"><?php _e( 'Do this later', 'twodayssss' ); ?></a>
			</div>
