...
class UM_Verified_Users_API {
	 ...
	 */
	function api() {
		require_once um_verified_users_path . 'includes/core/class-verified-users-main-api.php';
	 ...
	 */
	function enqueue() {
		require_once um_verified_users_path . 'includes/core/class-verified-users-enqueue.php';
	...
	function admin_upgrade() {
		require_once um_verified_users_path . 'includes/admin/core/class-admin-upgrade.php';
    ...
    function um_verified_email_notifications( $email_notifications ) {
        ...
        $email_notifications['verified_account'] = array(
            ...
            'title'         => __( 'Account is verified E-mail', 'twodayssss' ),
            ...
            'body'          => 'Hi {display_name},<br /><br />' .
                ...
                'Thank You!<br />' .
                '{site_name}',
            'description'   => __('Send a notification to user when his account is verified','twodayssss'),
            'recipient'   => 'user',
            'default_active' => true
        );
        ...
        $email_notifications['verification_request'] = array(
            ...
            'title'         => __( 'Verification Request  E-mail', 'twodayssss' ),
            ...
            'body'          => '{display_name} ({username}) has requested that their account be verified.<br /><br />' .
                ...
                '{verify_reject}',
            'description'   => __('Send a notification e-mail to admin when a user requests to have their account verified.','twodayssss'),
            'recipient'   => 'admin',
            'default_active' => true
        );
