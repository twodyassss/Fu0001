...
class Messaging_GDPR {
	...
	function render_download_chat_link( $message_to, $user_id ) {
		...
		<a href="<?php echo $this->get_download_url( $response['conversation_id'] ) ?>"
		   ...
		   class="um-gdpr-donwload-link um-tip-e" title="<?php esc_attr_e( 'Download History', 'twodayssss' ); ?>"
	...
	function render_download_all_chats_link() {
		...
		<a href="<?php echo $this->get_download_url( 'all' ) ?>" class="um-link um-gdpr-donwload-link" title="<?php esc_attr_e( 'Download History', 'twodayssss' ); ?>"><?php esc_html_e( 'Download Chats History', 'twodayssss' ) ?></a>
		<?php
	}
