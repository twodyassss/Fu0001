...
class Social_Login_Admin {
	...
	function extend_admin_menu() {
		add_submenu_page( 'ultimatemember', __( 'Social Login', 'twodayssss' ), __( 'Social Login', 'twodayssss' ), 'manage_options', 'edit.php?post_type=um_social_login', '' );
	}
	...
	function load_metabox() {
		...
		add_meta_box('um-metaboxes-social', __( 'Social Signups', 'twodayssss' ), array( &$this, 'metabox_content' ), 'toplevel_page_ultimatemember', 'normal', 'core' );
	}
	...
	function add_metabox_form() {
		...
		add_meta_box('um-admin-social-login-buttons', __('Options','twodayssss'), array(&$this, 'load_metabox_form'), 'um_social_login', 'normal', 'default');
		add_meta_box('um-admin-social-login-shortcode', __('Shortcode','twodayssss'), array(&$this, 'load_metabox_form'), 'um_social_login', 'side', 'default');
