...
class UM_Activity_API {
	...
	function download_routing() {
		...
		header('Content-Module Description: File Transfer');
     ...
     */
    function api() {
		if ( ! class_exists( 'um_ext\um_social_activity\core\Activity_Main_API' ) )
        require_once um_activity_path . 'includes/core/class-activity-main-api.php';
     ...
     */
    function shortcode() {
		if ( ! class_exists( 'um_ext\um_social_activity\core\Activity_Shortcode' ) )
        require_once um_activity_path . 'includes/core/class-activity-shortcode.php';
     ...
     */
    function enqueue() {
		if ( ! class_exists( 'um_ext\um_social_activity\core\Activity_Enqueue' ) )
        require_once um_activity_path . 'includes/core/class-activity-enqueue.php';
     ...
     */
    function admin() {
		if ( ! class_exists( 'um_ext\um_social_activity\core\Activity_Admin' ) )
        require_once um_activity_path . 'includes/core/class-activity-admin.php';
