...
function um_activity_confirm_box() {
	...
	<div class="um-activity-confirm">
		...
		<div class="um-activity-confirm-b">
			<a href="javascript:void(0);" class="um-activity-confirm-btn"><?php _e('Yes','twodayssss'); ?></a>
			<a href="javascript:void(0);" class="um-activity-confirm-close"><?php _e('No','twodayssss'); ?></a>
		</div>
	</div>
