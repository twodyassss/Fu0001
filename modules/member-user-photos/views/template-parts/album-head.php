...
<div class="um-user-photos-album-head">
	<div class="col-back">
		...
		>
			<span class="um-icon-arrow-left-c"></span> <?= __('Back','twodayssss'); ?>
		</a>
	</div>
			...
			<div class="um-dropdown-b">
				...
				<ul>
					<li>
						...
						>
							<?= __('Edit album','twodayssss'); ?>
						</a>
					</li>
					<li>
						<a href="#"
						   data-trigger="um-user-photos-modal"
						   data-modal_title="<?= __('Delete album','twodayssss'); ?>"
						   data-modal_view="album-delete"
						   original-title="<?= __('Delete album','twodayssss'); ?>"
						   data-action="<?= admin_url('admin-ajax.php?action=get_um_user_photos_view'); ?>"
