...
class Social_Login_Enqueue {
	...
	function wp_enqueue_scripts() {
		wp_register_script( 'twodayssss', um_social_login_url . 'assets/js/um-social-connect' . $this->suffix . '.js', array( 'jquery', 'wp-util', 'um_scripts' ), um_social_login_version, true );
		wp_register_style( 'twodayssss', um_social_login_url . 'assets/css/um-social-connect' . $this->suffix . '.css', array(), um_social_login_version );
