	...
	class myCRED_Dashboard_Widget_Overview {
		...
		public static function init() {
			...
			wp_add_dashboard_widget(
				self::mycred_wid,
				sprintf( __( '%s Overview', 'twodayssss' ), mycred_label() ),
...
?>
	<div class="mycred-type clear<?php if ( $counter == 0 ) echo ' first'; ?>">
		<div class="module-title">
			...
			<a href="<?php echo $url; ?>" title="<?php _e( 'Total amount in circulation', 'twodayssss' ); ?>"><?php echo $mycred->format_creds( $total ); ?></a>
		...
		<div class="overview clear">
			<div class="section border" style="width: 50%;">
				<p>
					...
					<strong style="color:green;"><?php _e( 'Awarded', 'twodayssss' ); ?>:</strong>
			...
			<div class="section border" style="width: 50%; margin-left: -1px;">
				<p>
					...
					<strong style="color:red;"><?php _e( 'Deducted', 'twodayssss' ); ?>:</strong>
