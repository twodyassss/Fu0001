...
if ( ! class_exists( 'myCRED_Hook' ) ) :
	abstract class myCRED_Hook {
		...
		public function preferences() {
			...
			echo '<p>' . __( 'This Hook has no settings', 'twodayssss' ) . '</p>';
		...
		public function get_limit_types() {
			...
			return apply_filters( 'mycred_hook_limits', array(
				'x' => __( 'No limit', 'twodayssss' ),
				'd' => __( '/ Day', 'twodayssss' ),
				'w' => __( '/ Week', 'twodayssss' ),
				'm' => __( '/ Month', 'twodayssss' ),
				't' => __( 'in Total', 'twodayssss' )
			), $this );
		...
		public function impose_limits_dropdown( $pref_id = '', $use_select = true ) {
			...
			$settings = '';
			$limits   = array(
				''           => __( 'No limit', 'twodayssss' ),
				'twentyfour' => __( 'Once every 24 hours', 'twodayssss' ),
				'sevendays'  => __( 'Once every 7 days', 'twodayssss' ),
				'daily'      => __( 'Once per day (reset at midnight)', 'twodayssss' )
			);
			...
			if ( $use_select )
				echo '<option value="">' . __( 'Select', 'twodayssss' ) . '</option>';
