<div class="um-notification-header">
	<div class="um-notification-left"><?php _e('Notifications','twodayssss'); ?></div>
...
<div class="um-notifications-none" style="display:none;">
	...
	<?php _e( 'No new notifications', 'twodayssss' ); ?>
</div>

<div class="um-notification-more">
	<a href="<?php echo um_get_core_page( 'notifications' ); ?>"><?php _e( 'See all notifications', 'twodayssss' ); ?></a>
</div>
