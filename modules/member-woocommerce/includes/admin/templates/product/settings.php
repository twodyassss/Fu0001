<div class="um-admin-metabox">
	<?php $roles = array( '' => __( 'None','twodayssss' ) ) + UM()->roles()->get_roles();
    ...
    $meta_fields = array(
        array(
            ...
            'type'		    => 'select',
            'label'    		=> __( 'When this product is bought move user to this role', 'twodayssss' ),
    ...
    if ( function_exists( 'wcs_get_subscription' ) ) {
        ...
        $meta_fields[] = array(
            ...
            'type'		    => 'select',
            'label'    		=> __( 'When subscription is ACTIVATED move user to this role', 'twodayssss' ),
        ...
        $meta_fields[] = array(
            ...
            'type'		    => 'select',
            'label'    		=> __( 'When subscription is PENDING move user to this role', 'twodayssss' ),
        ...
        $meta_fields[] = array(
            ...
            'type'		    => 'select',
            'label'    		=> __( 'When subscription is ON-HOLD move user to this role', 'twodayssss' ),
        ...
        $meta_fields[] = array(
            ...
            'type'		    => 'select',
            'label'    		=> __( 'When subscription is EXPIRED move user to this role', 'twodayssss' ),
        ...
        $meta_fields[] = array(
            ...
            'type'		    => 'select',
            'label'    		=> __( 'When subscription is CANCELLED move user to this role', 'twodayssss' ),
            ...
            'options'       => $roles,
				...
				$meta_fields[] = array(
					...
					'type'		 => 'select',
					'label'		 => __( 'When subscription is PENDING-CANCEL move user to this role', 'twodayssss' ),
