...
function mycred_register_contact_form_seven_hook( $installed ) {
	...
	$installed['contact_form7'] = array(
		'title'         => __( 'Contact Form 7 Form Submissions', 'twodayssss' ),
		'description'   => __( 'Awards %_plural% for successful form submissions (by logged in users).', 'twodayssss' ),
		'documentation' => '',
...
function mycred_load_contact_form_seven_hook() {
	...
	class myCRED_Contact_Form7 extends myCRED_Hook {
		...
		public function preferences() {
			...
			// No forms found
			if ( empty( $forms ) ) {
				echo '<p>' . __( 'No forms found.', 'twodayssss' ) . '</p>';
				return;
			}
...
<div class="hook-instance">
	<h3><?php printf( __( 'Form: %s', 'twodayssss' ), $form_title ); ?></h3>
	<div class="row">
		...
		<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
			<div class="form-group">
				<label for="<?php echo $this->field_id( array( $form_id, 'limit' ) ); ?>"><?php _e( 'Limit', 'twodayssss' ); ?></label>
		...
		<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
			<div class="form-group">
				<label for="<?php echo $this->field_id( array( $form_id, 'log' ) ); ?>"><?php _e( 'Log template', 'twodayssss' ); ?></label>
				<input type="text" name="<?php echo $this->field_name( array( $form_id, 'log' ) ); ?>" id="<?php echo $this->field_id( array( $form_id, 'log' ) ); ?>" placeholder="<?php _e( 'required', 'twodayssss' ); ?>" value="<?php echo esc_attr( $prefs[ $form_id ]['log'] ); ?>" class="form-control" />
