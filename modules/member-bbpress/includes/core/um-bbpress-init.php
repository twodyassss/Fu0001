...
class UM_bbPress_API {
	 ...
	 */
	function enqueue() {
		if ( ! class_exists( 'um_ext\um_bbpress\core\bbPress_Enqueue' ) )
		require_once um_bbpress_path . 'includes/core/class-bbpress-enqueue.php';
	...
	function get_weekdays() {
		$array['sun'] = __( 'Sunday', 'twodayssss' );
		$array['mon'] = __( 'Monday', 'twodayssss' );
		$array['tue'] = __( 'Tuesday', 'twodayssss' );
		$array['wed'] = __( 'Wednesday', 'twodayssss' );
		$array['thu'] = __( 'Thursday', 'twodayssss' );
		$array['fri'] = __( 'Friday', 'twodayssss' );
		$array['sat'] = __( 'Saturday', 'twodayssss' );
		return $array;
	}
