	...
	<?php UM()->admin_forms( array(
		...
		'fields' => array(
			array(
				'id'		    => '_um_show_in_urls',
				'type'		    => 'checkbox',
				'label'		    => __( 'Show on specific URLs only', 'twodayssss' ),
				'value'		    => UM()->query()->get_meta_value( '_um_show_in_urls', null, 0 ),
			),
			array(
				'id'		    => '_um_allowed_urls',
				'type'		    => 'textarea',
				'label'		    => __( 'Enter allowed URLs one per line', 'twodayssss' ),
			...
			array(
				'id'		    => '_um_show_in_home',
				'type'		    => 'checkbox',
				'label'		    => __( 'Show on Homepage', 'twodayssss' ),
			...
			array(
				...
				'type'		    => 'checkbox',
				'label'		    => __( 'Show on Posts', 'twodayssss' ),
			...
			array(
				...
				'type'		    => 'checkbox',
				'label'		    => __( 'Show on Pages', 'twodayssss' ),
			...
			array(
				...
				'type'		    => 'checkbox',
				'label'		    => __( 'Show on Custom Post Types', 'twodayssss' ),
