...
class UM_Friends_API {
	 ...
	 */
	function api() {
		require_once um_friends_path . 'includes/core/class-friends-main-api.php';
	 ...
	 */
	function enqueue() {
		require_once um_friends_path . 'includes/core/class-friends-enqueue.php';
	 ...
	 */
	function shortcode() {
		require_once um_friends_path . 'includes/core/class-friends-shortcode.php';
