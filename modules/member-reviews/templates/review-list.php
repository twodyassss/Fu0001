...
foreach ( $reviews as $review ) {
	...
	<div class="um-reviews-item" id="review-<?php echo esc_attr( $review->ID ); ?>" data-review_id="<?php echo esc_attr( $review->ID ); ?>" data-user_id="<?php echo esc_attr( um_profile_id() ); ?>">
		...
		<div class="um-reviews-post review-list">
			...
			<span class="um-reviews-meta"><?php printf( __('by <a href="%s">%s</a>, %s','twodayssss' ), um_user_profile_url(), um_user( 'display_name' ), get_the_time( UM()->options()->get( 'review_date_format' ), $review ) ); ?></span>
		...
		<div class="um-reviews-post review-form">
			...
			<form class="um-reviews-form" action="" method="post">
				...
				<span class="um-reviews-title"><input type="text" name="title" placeholder="<?php esc_attr_e('Enter subject...','twodayssss'); ?>" value="<?php echo esc_attr( $review->post_title ); ?>" /></span>
				...
				<span class="um-reviews-content">
					<textarea name="content" placeholder="<?php esc_attr_e('Enter your review...','twodayssss'); ?>"><?php echo esc_textarea( isset( $content ) ? $content: '' ); ?></textarea>
				</span>
				...
				<span class="um-reviews-send">
					<input type="submit" value="<?php esc_attr_e('Save Review','twodayssss'); ?>" class="um-button" />
				</span>
