...
class UM_reCAPTCHA {
	 ...
	 */
	function enqueue() {
		if ( ! class_exists( 'um_ext\um_recaptcha\core\reCAPTCHA_Enqueue' ) )
		require_once um_recaptcha_path . 'includes/core/class-recaptcha-enqueue.php';
	 ...
	 */
	function admin() {
		if ( ! class_exists( 'um_ext\um_recaptcha\admin\reCAPTCHA_Admin' ) )
		require_once um_recaptcha_path . 'includes/admin/class-recaptcha-admin.php';
