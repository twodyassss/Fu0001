...
class Profile_Completeness_Admin {
	...
	function admin_enqueue_scripts() {
		if ( UM()->admin()->is_um_screen() ) {
			wp_register_script( 'um_admin_profile_completeness', um_profile_completeness_url . 'assets/js/um-admin-profile-completeness.js', array( 'jquery' ), um_profile_completeness_version, true );
			wp_register_style( 'um_admin_profile_completeness', um_profile_completeness_url . 'assets/css/um-admin-profile-completeness.css', array(), um_profile_completeness_version );
