...
//						$current_conversation = esc_attr( absint( $_GET['conversation_id'] ) );
		...
		$output = twodays_get_template( 'conversations.php', um_messaging_plugin, $args );
//
...
//		$output = ob_get_clean();
	...
	function ultimatemember_message_button( $args = array() ) {
		...
		return twodays_get_template( 'button.php', um_messaging_plugin, $args );
	}
