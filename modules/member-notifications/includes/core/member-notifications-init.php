...
class UM_Notifications_API {
    ...
    function um_notification_core_page( $pages ) {
        $pages['notifications'] = array( 'title' => __( 'Notifications', 'twodayssss' ) );
        return $pages;
    }
    ...
    function api() {
		...
		require_once um_notifications_path . 'includes/core/class-notifications-main-api.php';
     ...
     */
    function enqueue() {
		if ( ! class_exists( 'um_ext\um_notifications\core\Notifications_Enqueue' ) )
		require_once um_notifications_path . 'includes/core/class-notifications-enqueue.php';
     ...
     */
    function shortcode() {
		if ( ! class_exists( 'um_ext\um_notifications\core\Notifications_Shortcode' ) )
		require_once um_notifications_path . 'includes/core/class-notifications-shortcode.php';
