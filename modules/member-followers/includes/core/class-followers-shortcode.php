...
class Followers_Shortcode {
	...
	function ultimatemember_followers_bar( $args = array() ) {
		...
		<div class="um-followers-rc">
			<?php if ( $can_view ) { ?>
				<a href="<?php echo UM()->Followers_API()->api()->followers_link( $user_id ); ?>" class="<?php if ( $active_tab == 'followers' ) { echo 'current'; } ?>"><?php _e('followers','twodayssss'); ?><?php echo UM()->Followers_API()->api()->count_followers( $user_id ); ?></a>
			<?php } ?>
		</div>

		<div class="um-followers-rc">
			<?php if ( $can_view ) { ?>
				<a href="<?php echo UM()->Followers_API()->api()->following_link( $user_id ); ?>" class="<?php if ( $active_tab == 'following' ) { echo 'current'; } ?>"><?php _e('following','twodayssss'); ?><?php echo UM()->Followers_API()->api()->count_following( $user_id ); ?></a>
			<?php } ?>
		</div>
