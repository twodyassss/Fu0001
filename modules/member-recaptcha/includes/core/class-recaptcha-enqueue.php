	...
	function wp_enqueue_scripts() {
		...
		switch( $version ) {
			case 'v3':
				...
				wp_register_script( 'twodayssss', um_recaptcha_url . 'assets/js/um-recaptcha.js', array( 'jquery', 'google-recapthca-api-v3' ), um_recaptcha_version, true );
			...
			default:
				...
				wp_register_script( 'twodayssss', um_recaptcha_url . 'assets/js/um-recaptcha.js', array( 'jquery', 'google-recapthca-api-v2' ), um_recaptcha_version, true );
		...
		wp_localize_script( 'twodayssss', 'umRecaptchaData', array(
				'version'	 => $version,
				'site_key' => $site_key
		) );
	}
