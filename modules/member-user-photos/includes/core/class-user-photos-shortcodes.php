...
class User_Photos_Shortcodes {
	...
	function wp_enqueue_scripts(){
		...
		wp_register_style( 'twodayssss', um_user_photos_url . 'assets/css/um-user-photos' . $suffix . '.css', array( 'umfancyboxcss' ), um_user_photos_version );
		...
		wp_register_script( 'twodayssss', um_user_photos_url . 'assets/js/um-user-photos' . $suffix . '.js', array( 'wp-util', 'umfancybox' ), um_user_photos_version, true );
	}
